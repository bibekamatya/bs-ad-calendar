    ...
    <div className="bg-linear-to-br from-gray-50 via-gray-50 to-gray-100 min-h-screen">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row gap-8">
          {/* Tabs - Fixed on left */}
          <div className="md:fixed md:left-0 md:top-0 md:h-screen md:w-48 md:overflow-y-auto md:pt-32 md:pl-4 md:pr-4 md:bg-white md:border-r md:border-gray-200 shrink-0">
            <Tabs
              tabs={[
