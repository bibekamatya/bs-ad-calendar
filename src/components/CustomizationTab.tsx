...
/>`
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      <div
        style={{ border: 'none', borderRadius: '0px', padding: '0px', background: 'transparent' }}
      >
        <h3 style={{ color: '#111827', marginTop: 0, marginBottom: '8px', fontSize: '16px' }}>
        ...
        >
          ...
          <div>
            <Calendar calendarType="BS" colors={colors} onDateSelect={onADSelect} />
          </div>
        </div>
